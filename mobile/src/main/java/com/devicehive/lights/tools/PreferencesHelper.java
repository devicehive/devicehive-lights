...
public class PreferencesHelper {
    ...
    private static final String IS_LOGGED_SUCCESSFULY = "isLoggedSuccessfully";
    ...
    public void putIsLoggedSuccessfully(boolean isLogged) {
        sharedPreferences.edit().putBoolean(IS_LOGGED_SUCCESSFULY, isLogged).apply();
    }

    public boolean isLoggedSuccessfully() {
        return sharedPreferences.getBoolean(IS_LOGGED_SUCCESSFULY, false);
    }
}
